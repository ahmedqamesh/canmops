...
from mopshub_gui          import menuWindow, childWindow, opcuaWindow, dataMonitoring, mopsChildWindow
...
class MainWindow(QMainWindow):
    ...
    def default_message_window(self):
        ...
        self.startButton.setIcon(QIcon('mopshub_gui/icons/icon_start.png'))
    ...
    def configure_cic_box(self):
        ...
        opcuaLabel.setText("")
        self.opcuaButton.setIcon(QIcon('mopshub_gui/icons/icon_opcua.png'))
    ...
    def configure_device_box(self):
        ...
        if self.__devices[0] == "None":
            ...
            self.deviceButton.setIcon(QIcon('mopshub_gui/icons/icon_question.png'))
    ...
    def read_sdo_can(self):
        ...
        The function is called by the following functions: 
           a) update_adc_channels
           b)  update_monitoring_values    
           c) update_configuration_values
        """
        try:
    ...
    def send_random_can(self): 
        ...
        The function is called by the following functions: 
           a)  dump_random_message_action button
    ...
    def initiate_adc_timer(self, period=3):
        ...
        if len(self.__default_file) != 0:
            ...
            self.out_file_csv = AnalysisUtils().open_csv_file(outname=self.__default_file, directory=lib_dir + "output_data") 
            ...
            writer.writeheader()            
            eventTimer = mopsChildWindow.EventTimer()
            self.adc_timer = eventTimer.initiate_timer(period)
    ...
    def show_toolBar(self, toolbar, mainwindow): 
        ...
        canMessage_action = QAction(QIcon('mopshub_gui/icons/icon_msg.jpg'), '&CAN Message', mainwindow)
        ...
        settings_action = QAction(QIcon('mopshub_gui/icons/icon_settings.jpeg'), '&CAN Settings', mainwindow)
        ...
        dump_can_message_action = QAction(QIcon('mopshub_gui/icons/icon_dump.png'), '&CAN Dump', mainwindow)
        ...
        run_random_message_action = QAction(QIcon('mopshub_gui/icons/icon_right.jpg'), '&CAN Run', mainwindow)
        ...
        stop_dump_message_action = QAction(QIcon('mopshub_gui/icons/icon_stop.png'), '&CAN Stop', mainwindow)
        ...
        dump_random_message_action = QAction(QIcon('mopshub_gui/icons/icon_random.png'), '&CAN Random', mainwindow)
        ...
        clear_action = QAction(QIcon('mopshub_gui/icons/icon_clear.png'), '&Clear', mainwindow)
        ...
        plot_adc__action = QAction(QIcon('mopshub_gui/icons/icon_curve.png'), '&Plotting', mainwindow)
    ...
    def show_CANMessageWindow(self):
       try:
            ...
            child = childWindow.ChildWindow(parent = self.MessageWindow)
    ...
    def show_CANSettingsWindow(self):
        ...
        child = childWindow.ChildWindow(parent = self.SettingsWindow)
        self.interfaceComboBox, self.channelSettingsComboBox , self.firsttextbox = child.can_settings_child_window(self.SettingsWindow, 
    ...
    def show_deviceWindow(self):
        ...
        try:
            ...
            pass
        self.channelValueBox, self.trendingBox , self.monValueBox , self.confValueBox, self.progressBar = mopsChildWindow.MopsChildWindow().device_child_window(childWindow=self.deviceWindow, mainWindow= self)
    ...
    def show_adc_plotting_window(self):
        ...
        ChildWindow = childWindow.ChildWindow(parent = self.plotWindow)
